...
const std::map<State, array<Instruction, 2>> FiveStateBusyBeaver::championInstructionTable{
	{ State::A, array<Instruction, 2>{ Instruction{ '1', Direction::RIGHT,	State::B },		Instruction{ '1', Direction::LEFT,	State::C } } },
	{ State::B, array<Instruction, 2>{ Instruction{ '1', Direction::RIGHT,	State::C },		Instruction{ '1', Direction::RIGHT,	State::B } } },
	{ State::C, array<Instruction, 2>{ Instruction{ '1', Direction::RIGHT,	State::D },		Instruction{ '0', Direction::LEFT,	State::E } } },
	{ State::D, array<Instruction, 2>{ Instruction{ '1', Direction::LEFT,	State::A },		Instruction{ '1', Direction::LEFT,	State::D } } },
	{ State::E, array<Instruction, 2>{ Instruction{ '1', Direction::RIGHT,	State::HALT },	Instruction{ '0', Direction::LEFT,	State::A } } }
};
